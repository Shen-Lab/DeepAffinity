...
fc_2 = fully_connected(merging, 300, activation='leakyrelu',weights_init="xavier",name='fully2')
drop_3 = dropout(fc_2, 0.8)
fc_3 = fully_connected(drop_3, 100, activation='leakyrelu',weights_init="xavier",name='fully2')
...
feature_ER_protein = np.reshape(feature_ER_protein,[len(feature_ER_protein),512])
feature_ER_compound = np.reshape(feature_ER_compound,[len(feature_ER_compound),256])
label_ER = np.reshape(label_ER,[len(label_ER),1])
...
feature_GPCR_protein = np.reshape(feature_GPCR_protein,[len(feature_GPCR_protein),512])
feature_GPCR_compound = np.reshape(feature_GPCR_compound,[len(feature_GPCR_compound),256])
label_GPCR = np.reshape(label_GPCR,[len(label_GPCR),1])
...
feature_kinase_protein = np.reshape(feature_kinase_protein,[len(feature_kinase_protein),512])
feature_kinase_compound = np.reshape(feature_kinase_compound,[len(feature_kinase_compound),256])
label_kinase = np.reshape(label_kinase,[len(label_kinase),1])
...
feature_train_protein = np.reshape(feature_train_protein,[len(feature_train_protein),512])
feature_train_compound = np.reshape(feature_train_compound,[len(feature_train_compound),256])
...
feature_test_protein = np.reshape(feature_test_protein,[len(feature_test_protein),512])
feature_test_compound = np.reshape(feature_test_compound,[len(feature_test_compound),256])
