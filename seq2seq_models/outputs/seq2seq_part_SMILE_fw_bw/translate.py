...
tf.app.flags.DEFINE_integer("num_train_step", 200000,
                            "max number of training step")
tf.app.flags.DEFINE_integer("size", 128, "Size of each model layer.")
tf.app.flags.DEFINE_integer("num_layers", 2, "Number of layers in the model.")
tf.app.flags.DEFINE_integer("from_vocab_size", 45, "English vocabulary size.")
tf.app.flags.DEFINE_integer("to_vocab_size", 45, "French vocabulary size.")
tf.app.flags.DEFINE_string("data_dir", "./data", "Data directory")
tf.app.flags.DEFINE_string("train_dir", "./data", "Training directory.")
tf.app.flags.DEFINE_string("from_train_data","./data/SMILE_from.txt", "Training data.")
tf.app.flags.DEFINE_string("to_train_data", "./data/SMILE_to.txt", "Training data.")
tf.app.flags.DEFINE_string("from_dev_data", "./data/SMILE_from_dev.txt", "Training data.")
tf.app.flags.DEFINE_string("to_dev_data", "./data/SMILE_to_dev.txt", "Training data.")
