  ...
  def step(self, session, encoder_inputs, decoder_inputs, target_weights,
    ...
    if is_saving == 1:
     ...
     for v in tf.trainable_variables():
       if "embedding_attention_seq2seq/rnn/embedding_wrapper/multi_rnn_cell/cell_0/gru_cell/gates/kernel" in v.name:
          variables_names.append(v)
       elif "embedding_attention_seq2seq/rnn/embedding_wrapper/multi_rnn_cell/cell_0/gru_cell/gates/bias" in v.name:
          variables_names.append(v)
       elif "embedding_attention_seq2seq/rnn/embedding_wrapper/multi_rnn_cell/cell_0/gru_cell/candidate/kernel" in v.name:
          variables_names.append(v)
       elif "embedding_attention_seq2seq/rnn/embedding_wrapper/multi_rnn_cell/cell_0/gru_cell/candidate/bias" in v.name:
          variables_names.append(v)
       elif "embedding_attention_seq2seq/rnn/embedding_wrapper/multi_rnn_cell/cell_1/gru_cell/gates/kernel" in v.name:
          variables_names.append(v)
       elif "embedding_attention_seq2seq/rnn/embedding_wrapper/multi_rnn_cell/cell_1/gru_cell/gates/bias" in v.name:
          variables_names.append(v)
       elif "embedding_attention_seq2seq/rnn/embedding_wrapper/multi_rnn_cell/cell_1/gru_cell/candidate/kernel" in v.name:
          variables_names.append(v)
       elif "embedding_attention_seq2seq/rnn/embedding_wrapper/multi_rnn_cell/cell_1/gru_cell/candidate/bias" in v.name:
          variables_names.append(v)
       elif "embedding_attention_seq2seq/rnn/embedding_wrapper/embedding" in v.name:
          variables_names.append(v)
