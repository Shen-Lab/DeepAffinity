...
tf.app.flags.DEFINE_integer("num_train_step", 100000,
                            "max number of training step")
tf.app.flags.DEFINE_integer("size", 256, "Size of each model layer.")
tf.app.flags.DEFINE_integer("num_layers", 2, "Number of layers in the model.")
tf.app.flags.DEFINE_integer("from_vocab_size", 76, "English vocabulary size.")
tf.app.flags.DEFINE_integer("to_vocab_size", 76, "French vocabulary size.")
tf.app.flags.DEFINE_string("data_dir", "./data", "Data directory")
tf.app.flags.DEFINE_string("train_dir", "./data", "Training directory.")
tf.app.flags.DEFINE_string("from_train_data","./data/FASTA_from.txt", "Training data.")
tf.app.flags.DEFINE_string("to_train_data", "./data/FASTA_to.txt", "Training data.")
tf.app.flags.DEFINE_string("from_dev_data", "./data/FASTA_from_dev.txt", "Training data.")
tf.app.flags.DEFINE_string("to_dev_data", "./data/FASTA_to_dev.txt", "Training data.")
...
tf.app.flags.DEFINE_integer("SPS_max_length", 152,
                            "Maximum length of SPS.")
...
_buckets = [(FLAGS.SPS_max_length,FLAGS.SPS_max_length)]
  ...
  with tf.Session() as sess:
    ...
    while current_step<FLAGS.num_train_step:
      ...
      _, step_loss, _, enc_init_states,enc_all_outputs= model.step(sess, encoder_inputs, decoder_inputs,#MK change
                                   target_weights, bucket_id,False,1)
      ...
      if current_step % FLAGS.steps_per_checkpoint == 0:
        ...
        for bucket_id in xrange(len(_buckets)):
          ...
          _, eval_loss, _,_,_ = model.step(sess, encoder_inputs, decoder_inputs,
                                       target_weights, bucket_id, False,0)
