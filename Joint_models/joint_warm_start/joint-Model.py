...
def sentence_to_token_ids(sentence, vocabulary,condition,normalize_digits=True):
...
def data_to_token_ids(data_path, target_path, vocabulary_path, condition,normalize_digits=True):
...
ER_protein = prepare_data(data_dir,"./data/ER_protein",vocab_size_protein,vocab_protein,protein_MAX_size,1)
ER_compound = prepare_data(data_dir,"./data/ER_compound",vocab_size_compound,vocab_compound,comp_MAX_size,0)
ER_IC50 = read_labels("./data/ER_IC50")

GPCR_protein = prepare_data(data_dir,"./data/GPCR_protein",vocab_size_protein,vocab_protein,protein_MAX_size,1)
GPCR_compound = prepare_data(data_dir,"./data/GPCR_compound",vocab_size_compound,vocab_compound,comp_MAX_size,0)
GPCR_IC50 = read_labels("./data/GPCR_IC50")

kinase_protein = prepare_data(data_dir,"./data/channel_protein",vocab_size_protein,vocab_protein,protein_MAX_size,1)
kinase_compound = prepare_data(data_dir,"./data/channel_compound",vocab_size_compound,vocab_compound,comp_MAX_size,0)
kinase_IC50 = read_labels("./data/channel_IC50")

train_protein = prepare_data(data_dir,"./data/train_protein",vocab_size_protein,vocab_protein,protein_MAX_size,1)
train_compound = prepare_data(data_dir,"./data/train_compound",vocab_size_compound,vocab_compound,comp_MAX_size,0)
train_IC50 = read_labels("./data/train_IC50")

test_protein = prepare_data(data_dir,"./data/test_protein",vocab_size_protein,vocab_protein,protein_MAX_size,1)
test_compound = prepare_data(data_dir,"./data/test_compound",vocab_size_compound,vocab_compound,comp_MAX_size,0)
