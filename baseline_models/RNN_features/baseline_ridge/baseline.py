...
pickle.dump(y_pred_test,ridge_test_pkl)
...
ridge_pkl_train_filename = 'ridge_20182101_train_pred.pkl'
ridge_train_pkl = open(ridge_pkl_train_filename, 'wb')
pickle.dump(y_pred_train,ridge_train_pkl)
ridge_train_pkl.close()

######### Saving Real label train
ridge_pkl_train_filename = 'ridge_20182101_train_real_lable.pkl'
ridge_train_pkl = open(ridge_pkl_train_filename, 'wb')
pickle.dump(label_train,ridge_train_pkl)
ridge_train_pkl.close()
...
pickle.dump(y_pred_ER,ridge_ER_pkl)
ridge_ER_pkl.close()
...
pickle.dump(y_pred_kinase,ridge_kinase_pkl)
...
pickle.dump(y_pred_GPCR,ridge_GPCR_pkl)
...
ridge_pkl_channel_filename = 'ridge_20182101_channel_pred.pkl'
ridge_channel_pkl = open(ridge_pkl_channel_filename, 'wb')
pickle.dump(y_pred_channel,ridge_channel_pkl)
ridge_channel_pkl.close()

######### Saving Real label channel
ridge_pkl_channel_filename = 'ridge_20182101_channel_real_lable.pkl'
ridge_channel_pkl = open(ridge_pkl_channel_filename, 'wb')
pickle.dump(label_channel,ridge_channel_pkl)
ridge_channel_pkl.close()
